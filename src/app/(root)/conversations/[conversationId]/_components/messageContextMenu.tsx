  ...
  return (
    <Dialog>
      <ContextMenu>
        ...
        <ContextMenuContent
          className="bg-white border-[3px] border-border shadow-[4px_4px_0_0_#2d2d2d] font-[family-name:var(--font-patrick-hand)] text-base"
        ...
        >
          ...
          <DialogTrigger asChild>
            <ContextMenuItem variant="destructive" aria-label="Delete message">
      ...
      <DialogContent
        className="bg-white border-[3px] border-border shadow-[6px_6px_0_0_#2d2d2d]"
        style={{ borderRadius: "var(--radius-wobbly-sm)" }}
      >
        <DialogHeader>
          <DialogTitle>
          ...
          <DialogDescription>
            This action cannot be undone. You can choose to soft delete or hard
            delete the message.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
